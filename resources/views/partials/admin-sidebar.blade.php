<div class="aiz-sidebar-wrap">
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('stockin.history')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('StockIn History')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('stockin.create')}}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Add Stock In')}}</span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            <li class="aiz-side-nav-item">
                <a href="{{ route('cart.index') }}" class="aiz-side-nav-link">
                    <i class="las la-shopping-cart aiz-side-nav-icon"></i>
                    <span class="aiz-side-nav-text">{{ translate('Cart Analysis') }}</span>
                    <!-- <span class="aiz-side-nav-arrow"></span> -->
                </a>
            </li>
            @endif
            ...
            <li class="aiz-side-nav-item">
                ...
                <ul class="aiz-side-nav-list level-2">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('feedback.index') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{ translate('Customer Feedback') }}</span>
                        </a>
                    </li>
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('complain.index') }}" class="aiz-side-nav-link">
                            <span class="aiz-side-nav-text">{{ translate('Customer Complain') }}</span>
                        </a>
                    </li>

                    <li class="aiz-side-nav-item">
                        <a href="{{ route('cancel_list.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customer_packages.index', 'customer_packages.create', 'customer_packages.edit'])}}">
                            <span class="aiz-side-nav-text">{{ translate('Customer Cancel List') }}</span>
                        </a>
                    </li>
            ...
            @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
            <li class="aiz-side-nav-item">
                <a href="{{ route('user-log.index') }}" class="aiz-side-nav-link">
                    <i class="las la-user aiz-side-nav-icon"></i>
                    <span class="aiz-side-nav-text">{{ translate('User Activity History') }}</span>
                    <!-- <span class="aiz-side-nav-arrow"></span> -->
                </a>
            </li>
            @endif
